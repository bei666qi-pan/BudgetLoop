...
- [x] 2.3 Run the Windows launcher workflow/build gate and verify MSI version and icon.
...
- [x] 3.2 Tag the verified commit `v0.2.0`, create the GitHub Release with Windows and macOS assets, checksums, prerequisites, and validation notes.
- [x] 3.3 Verify the GitHub release assets and public web revision, then record the final delivery evidence.
