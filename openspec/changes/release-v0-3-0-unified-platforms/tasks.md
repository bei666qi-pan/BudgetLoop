...
- [x] 1.1 Add the canonical `VERSION` file and set every Web, backend, macOS, Windows, Tauri, Rust, and lockfile version to `0.3.0`.
...
- [x] 3.3 Add release notes for `v0.3.0` that describe the startup-feedback fix, desktop artifacts, prerequisites, checksums, and known signing limitations.
...
- [ ] 4.4 Tag `v0.3.0`, verify GitHub assets/checksums and the local `BudgetLoop.app`, then archive the completed change on `main`.
