...
Define the mandatory, durable and visible judge-led evaluation loop for BudgetLoop Agent Teams, including hard gates, real model verdicts, targeted rework, cumulative safety boundaries, public state and formal delivery acceptance.
...
New TaskRuns SHALL carry the settled high-water mark of the original Session budget. Budget, runtime, rate or safety-round boundaries SHALL pause or block for operator action rather than reset usage. An authenticated operator MAY explicitly add bounded recovery rounds or budget and resume.
