# team-session-collaboration Specification

## Purpose

Define isolated Agent sessions and the explicit, recipient-scoped, auditable communication channel between sessions in one work container.
