# production-web-deployment Specification

## Purpose

Define the production browser credential boundary, domestic GitHub-to-Gitee-to-Coolify deployment chain, and readiness evidence required before a rollout is complete.
