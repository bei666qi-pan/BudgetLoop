# token-observatory Specification

## Purpose

Define the run-detail token metering observability panel: aggregate metering metrics, consumption trend visualization, per-call metering detail, and honest handling of partial metering data, all derived from existing llm-calls and budget API data.
